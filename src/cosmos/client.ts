...
import * as cosmosDynamicfeeV1TxRegistry from "./dynamicfee/v1/tx.registry";
...
import * as cosmosDynamicfeeV1TxAmino from "./dynamicfee/v1/tx.amino";
...
export const cosmosAminoConverters = {
  ...
  ...cosmosDynamicfeeV1TxAmino.AminoConverter,
