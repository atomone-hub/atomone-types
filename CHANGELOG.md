# @atomone/atomone-types

## 4.1.0

### Minor Changes

- [#1](https://github.com/atomone-hub/atomone-types/pull/1) [`530a3f4`](https://github.com/atomone-hub/atomone-types/commit/530a3f48c78eb36803c85b611bc568a97781b449) Thanks [@clockworkgr](https://github.com/clockworkgr)! - Restore the decoder registry, and publish the compiled output from `dist/`.
